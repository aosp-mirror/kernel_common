...
#define ARM_SMCCC_KVM_FUNC_IOMMU_MAP		10
#define ARM_SMCCC_KVM_FUNC_IOMMU_UNMAP		11
#define ARM_SMCCC_KVM_FUNC_IOMMU_ATTACH_DEV	12
#define ARM_SMCCC_KVM_FUNC_IOMMU_DETACH_DEV	13
#define ARM_SMCCC_KVM_FUNC_IOMMU_VERSION	14
#define ARM_SMCCC_KVM_FUNC_IOMMU_GET_FEATURE	15
#define ARM_SMCCC_KVM_FUNC_IOMMU_ALLOC_DOMAIN	16
#define ARM_SMCCC_KVM_FUNC_IOMMU_FREE_DOMAIN	17
...
#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_MAP_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_MAP)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_UNMAP_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_UNMAP)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_ATTACH_DEV_FUNC_ID		\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_ATTACH_DEV)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_DETACH_DEV_FUNC_ID		\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_DETACH_DEV)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_VERSION_FUNC_ID			\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_VERSION)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_GET_FEATURE_FUNC_ID		\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_GET_FEATURE)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_ALLOC_DOMAIN_FUNC_ID		\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
			   ARM_SMCCC_KVM_FUNC_IOMMU_ALLOC_DOMAIN)

#define ARM_SMCCC_VENDOR_HYP_KVM_IOMMU_FREE_DOMAIN_FUNC_ID		\
	ARM_SMCCC_CALL_VAL(ARM_SMCCC_FAST_CALL,				\
			   ARM_SMCCC_SMC_64,				\
			   ARM_SMCCC_OWNER_VENDOR_HYP,			\
